...
void update_H_worker(Point space[], int &Nx, int &Ny, double mux[], double muy[], double dx, double dy)
{
    double CEx{}; //curl of Ez in x
    double CEy{}; //curl of Ez in y
...
void update_E_worker(Point space[], int &Nx, int &Ny, double ep[], double dx, double dy, double dt)
{
    double CHz{};
    double new_Dz{};
    double c{299792458};
